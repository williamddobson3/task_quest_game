...
import second_tutorial from '../../assets/second_tutorial.png';
  ...
  return (
    <div className='w-full h-screen flex justify-center items-center'>
      ...
      <div className='flex justify-center items-center w-full h-full z-[100] absolute '>
        <div className='w-[330px] lg:w-[700px] xl:w-[600px] absolute top-40 lg:top-50 xl:top-30 left-10 lg:left-70 xl:left-140 flex justify-center items-center '>
          <div className='flex justify-center items-center gap-3 relative'>
            <div className='w-[300px] lg:w-[750px] xl:w-[500px] h-auto'>
        ...
        <div className='w-[220px] lg:w-[600px] xl:w-[400px] absolute top-85 lg:top-180 xl:top-20 right-10 lg:right-10 xl:right-170 flex justify-center items-center '>
