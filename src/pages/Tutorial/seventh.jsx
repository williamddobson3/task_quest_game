...
import seventh_tutorial from '../../assets/seventh_tutorial.png';
  ...
  return (
    <div className='w-full h-screen flex justify-center items-start'>
      ...
      >
        <div className='w-full h-full flex flex-col justify-start items-center pt-20 lg:pt-32 xl:pt-16 relative'>
          ...
          <main className='w-full flex flex-col justify-start items-center'>
            ...
            <div className='w-full h-[250px] flex justify-end items-end xl:pl-[200px] relative pr-5 lg:pr-50 lg:mt-30 xl:mt-0 xl:pr-120 opacity-0'>

              <div className='w-[100px] lg:w-[200px] xl:w-[150px] h-auto xl:mb-50'>
                <img src={main_item} alt="main_item" className='w-full h-auto ' />
              </div>
            </div>
            <div className='w-full h-[200px] lg:h-[400px] xl:h-[200px] flex justify-center items-center xl:justify-end xl:pr-10 xl:pb-60 gap-3 mt-[75px] lg:mt-[25px] xl:mt-0 opacity-0'>
      ...
      <div className='flex justify-center items-center w-full h-full z-[100] absolute '>
        <div className='w-[330px] lg:w-[700px] xl:w-[400px] absolute top-40 lg:top-50 xl:top-60 left-10 lg:left-40 xl:left-200 flex justify-center items-center '>
          <img src={seventh_tutorial} alt="" className='w-full h-auto ' />
        </div>
        <div className='w-[250px] lg:w-[500px] xl:w-[400px] absolute top-100 lg:top-200 xl:top-90 left-0 xl:left-50 flex justify-center items-center '>
          <img src={hero_man} alt="" />
        </div>
        <div className='w-[150px] lg:w-[300px] xl:w-[200px] absolute top-90 lg:top-180 xl:top-120 right-0 lg:right-40 xl:right-25 flex justify-center items-center '>
          <img src={next} alt="" className='cursor-pointer hover:opacity-80' onClick={handleNext} />
        </div>

      </div>
      <main className='w-full flex flex-col justify-start items-center absolute top-90 lg:top-200 xl:top-110'>
        <div className='w-full h-[250px] flex justify-end items-end xl:pl-[200px] relative pr-5 lg:pr-50 lg:mt-30 xl:mt-0 xl:pr-120'>
          <div className='w-[100px] lg:w-[200px] xl:w-[150px] h-auto xl:mb-50'>
            <img src={main_item} alt="main_item" className='w-full h-auto ' />
          </div>
        </div>
        <div className='w-full h-[100px] lg:h-[400px] xl:h-[200px] flex justify-center items-center xl:justify-end xl:pr-10 xl:pb-60 gap-3 mt-[75px] lg:mt-[25px] xl:mt-0'>
          <div className='w-[100px] lg:w-[200px] xl:w-[150px] h-auto'>
            <img src={first_item} alt="first_item" className='w-full h-auto' />
          </div>
          <div className='w-[100px] lg:w-[200px] xl:w-[150px] h-auto'>
