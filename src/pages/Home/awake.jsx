      ...
      <div className='w-full h-full flex flex-col justify-start items-center pt-20 lg:pt-32 xl:pt-16'>
        ...
        <main className='w-full flex flex-col justify-start items-center'>
          <div className='w-full flex flex-col justify-start items-start pl-12 lg:pl-70 xl:pl-[600px] xl:pt-0'>
            ...
            <div className='flex justify-center items-center gap-3 relative z-[100]'>
          ...
          <div className='w-full flex justify-start items-start pl-5 xl:pl-[200px] xl:absolute xl:top-80'>
            <div className='w-[300px] lg:w-[600px] xl:w-[400px] h-auto z-[100] '>
              <img src={hero_man} alt="hero_man" className='w-full h-auto' />
            </div>
            <div className="absolute flex justify-center items-center bottom-37 xl:bottom-[-10px] right-0 lg:right-60 xl:right-150 w-[400px] lg:w-[800px] xl:w-[500px] ">
