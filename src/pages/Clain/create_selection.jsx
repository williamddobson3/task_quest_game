...
export default function CreateSelection() {
  ...
  const handleCreateClan = () => {
    ...
    const clanData = {
      ...
      leaderId: localStorage.getItem('userName') || 'Player',
      members: [localStorage.getItem('userName') || 'Player'],
      maxMembers: 5,
      createdAt: new Date().toISOString(),
      weeklyTasks: 0,
      weeklyGoal: 15 // 15 tasks per member
    };

    // Save clan data
    localStorage.setItem('userClan', JSON.stringify(clanData));
    
    // Add to clan list (for future clan browsing)
